    ...
    function PanShareHelper(){
        ...
        function confirmClick(){
            ...
            if(result.errno == -20){
                ...
                if(buttonTarget == 'download'){
                    ...
                    console.log("=================设置剪切板vcode");
                    console.log("axel '"+ result.list[0].dlink+"'"+" -n 6 -o "+" '"+result.list[0].server_filename+"'");
                    GM_setClipboard("axel '"+ result.list[0].dlink+"'"+" -n 6 -o "+" '"+result.list[0].server_filename+"'",'text');
        ...
        function linkButtonClick(){
            ...
            if(downloadLink.errno == -20) {
                ...
                dialog.open({title:'下载链接',type:'link',list:linkList,tip:tip});
                 console.log("=================设置剪切板");
                    console.log("axel '"+ downloadLink.list[0].dlink+"'"+" -n 6 -o "+" '"+downloadLink.list[0].server_filename+"'");
                    GM_setClipboard("axel '"+ downloadLink.list[0].dlink+"'"+" -n 6 -o "+" '"+downloadLink.list[0].server_filename+"'",'text');
        ...
        this.open = function(params){
            ...
            if(params.type == 'link'){
                ...
                if(params.showall){
                    ...
                    console.log("axel '"+ element.downloadlink+"'"+" -n 6 -o "+"'"+element.filename+".mp4'");
                    });
                }
            }
